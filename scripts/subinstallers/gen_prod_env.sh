...
if [[ ! -f "$DJANGO_PROD_FILE" ]]; then
    ...
    echo "MISTBORN_BASE_DOMAIN=${MISTBORN_BASE_DOMAIN}" >> $DJANGO_PROD_FILE
    echo "MISTBORN_BIND_IP=${MISTBORN_INTERNAL_IP}" >> $DJANGO_PROD_FILE
